...
var CarModel = _backbone2['default'].Model.extend({
...
var CarsCollection = _backbone2['default'].Collection.extend({
  url: 'https://api.parse.com/1/classes/cars',
  model: _car_model2['default'],
...
},{"./car_model":1,"backbone":5}],4:[function(require,module,exports){
'use strict';
...
var _cars_collection = require('./cars_collection');

var _cars_collection2 = _interopRequireDefault(_cars_collection);

var _car_template = require('./car_template');

var _car_template2 = _interopRequireDefault(_car_template);
...
var cars = new _cars_collection2['default']();
...
function renderCars() {
  ...
  cars.each(function (car) {
    ...
    var templateString = (0, _car_template2['default'])(data);
  ...
  // set ul to the body
  (0, _jquery2['default'])('body').html($ul); // .html replaces
}
...
},{"./car_template":2,"./cars_collection":3,"backbone":5,"jquery":6,"moment":7,"underscore":8}],5:[function(require,module,exports){
(function (global){
//     Backbone.js 1.2.3
